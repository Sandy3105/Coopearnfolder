    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>CoopEarn Ads</strong> help you get better reach in the available
                    users</p>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        <select name="select_cp" id="" class="form-control form-control" required>
